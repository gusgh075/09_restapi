package org.ho.cqrs.product.query.service;
...
import org.ho.cqrs.product.query.dto.response.ProductDTO;
...
import org.ho.cqrs.product.query.mapper.ProductMapper;
...
/* JPA같은 경우는 조회 결과를 Entity로 받아온다. 이를 다시 DTO로 바꿔야하는 번거로운 작업이 있다.
하지만 Mybatis는 매퍼를 통해서 조회 결과를 바로 DTO에 매핑할 수 있다. 이는 확실히 JPA 보다 편하다. Query Side의 장점으로 볼만 한다. */
@Service
