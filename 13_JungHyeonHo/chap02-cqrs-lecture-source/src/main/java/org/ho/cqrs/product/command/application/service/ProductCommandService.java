package org.ho.cqrs.product.command.application.service;

import lombok.RequiredArgsConstructor;
import org.ho.cqrs.common.service.FileStorageService;
import org.ho.cqrs.exception.BusinessException;
import org.ho.cqrs.exception.ErrorCode;
import org.ho.cqrs.product.command.application.dto.request.ProductCreateRequest;
import org.ho.cqrs.product.command.application.dto.request.ProductUpdateRequest;
import org.ho.cqrs.product.command.domain.aggregate.Product;
import org.ho.cqrs.product.command.domain.aggregate.ProductStatus;
import org.ho.cqrs.product.command.domain.repository.ProductRepository;
import org.ho.cqrs.product.command.infrastructure.repository.JpaProductRepository;
...
public class ProductCommandService {
  ...
  public void updateProduct(
    ...
    // 2) 조회된 Entity 수정 -> 1차캐시에 저장된 데이터가 수정되면 더티체킹으로 변화를 감지
